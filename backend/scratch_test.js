...
require('dotenv').config({ path: path.join(__dirname, '../../../../OneDrive/Desktop/AI-TRAVEL/ai-travel-planner/backend/.env') });
...
console.log('Running test manual generation for Goa, 5 days, 4 travelers, Luxury...');
